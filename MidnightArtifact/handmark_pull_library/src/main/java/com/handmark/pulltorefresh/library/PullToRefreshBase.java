...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
            ...
            case MotionEvent.ACTION_DOWN: {
                if (isReadyForPull()) {
                    ...
                    if (onScrollListener != null) {
                        onScrollListener.onTouchDown(mLastMotionY, mLastMotionX);
                    }
                }
                break;
            }
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_MOVE: {
                if (mIsBeingDragged) {
                    ...
                    if (onScrollListener != null) {
                        onScrollListener.onScrollPosition(mLastMotionX, mLastMotionY);
                        onScrollListener.onDistance(mLastMotionX - mInitialMotionX, mLastMotionY - mInitialMotionY);
                    }
                    pullEvent();
                    return true;
                }
            ...
            case MotionEvent.ACTION_UP: {
                if (onScrollListener != null) {
                    onScrollListener.onTouchUp(mLastMotionX, mLastMotionY);
                }
                if (mIsBeingDragged) {
                    mIsBeingDragged = false;
    ...
    public interface OnMyScrollListener {
        public void onScrollPosition(float x, float y);

        public void onTouchDown(float x, float y);

        public void onDistance(float x, float y);
