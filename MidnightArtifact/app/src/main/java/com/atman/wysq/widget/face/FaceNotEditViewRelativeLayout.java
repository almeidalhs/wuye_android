 ...
 * 电话 18578909061
 */
public class FaceNotEditViewRelativeLayout extends RelativeLayout implements
    ...
    public FaceNotEditViewRelativeLayout(Context context) {
        super(context);
        this.context = context;
    }

    public FaceNotEditViewRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public FaceNotEditViewRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
...
//        blogdetail_addemol_iv = (ImageView) findViewById(R.id.post_face_iv);
