package com.tbl.okhttputils.request;
    ...
    protected RequestBody buildRequestBody() {
        if (files == null || files.isEmpty()) {
            ...
            for (int i = 0; i < files.size(); i++) {
                ...
                Log.e("files.get(i)","files.get(i):"+files.get(i).file.getPath());
                Log.e("files.get(i)","files.get(i):"+files.get(i).file.length());
                Log.e("files.get(i)","files.get(i):"+files.get(i).file.getAbsolutePath());
