...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
	...
	private boolean isHitIndicator = false;
	...
	public void setData(List<ImageView> views, List<ADInfo> list, ImageCycleViewListener listener, int showPosition) {
		...
		if (isCycle) {
			...
			indicators = new ImageView[infos.size()];
		}
			...
			if (mImageCycleViewListener != null) {
				v.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						LogUtils.e("currentPosition:"+(currentPosition )+",infos.size()"+infos.size());
	...
	public void setHitIndicator(boolean hitIndicator) {
		isHitIndicator = hitIndicator;
	}
