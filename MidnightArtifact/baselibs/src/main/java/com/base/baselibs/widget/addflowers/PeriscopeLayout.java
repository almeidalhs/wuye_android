...
package com.base.baselibs.widget.addflowers;
...
public class PeriscopeLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        Drawable one = getResources().getDrawable(R.drawable.kiss_one);
        Drawable two = getResources().getDrawable(R.drawable.kiss_two);
        Drawable three = getResources().getDrawable(R.drawable.kiss_three);
        Drawable four = getResources().getDrawable(R.drawable.kiss_four);
    ...
    private PointF getPointF(int scale) {
        ...
        pointF.x = random.nextInt((mWidth - 50));//减去100 是为了控制 x轴活动范围,看效果 随意~~
        //再Y轴上 为了确保第二个点 在第一个点之上,我把Y分成了上下两半 这样动画效果好一些  也可以用其他方法
        pointF.y = random.nextInt((mHeight/4)) / scale;
        return pointF;
    }
